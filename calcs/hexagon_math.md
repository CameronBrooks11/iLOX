...
![\Large d^2 = s^2 + w^2](https://latex.codecogs.com/svg.image?\Large&space;d^2=s^2+w^2)
...
![Equation w = s + 2x](https://latex.codecogs.com/svg.image?\Large&space;w=s+2x)
...
![Equation s^2 = 2x^2](https://latex.codecogs.com/svg.image?\Large&space;s^2=2x^2)
![Equation x = s / √2](https://latex.codecogs.com/svg.image?\Large&space;x=\frac{s}{\sqrt{2}})

Substituting \( x \) into the width equation:

![Equation w = s + 2(s / √2)](https://latex.codecogs.com/svg.image?\Large&space;w=s+2(\frac{s}{\sqrt{2}}))
![Equation w = s(1 + √2)](https://latex.codecogs.com/svg.image?\Large&space;w=s(1+\sqrt{2}))

### Final Equations

Substituting \( w \) into the diagonal equation yields:

![Equation d^2 = s^2 + (s(1 + √2))^2](https://latex.codecogs.com/svg.image?\Large&space;d^2=s^2+(s(1+\sqrt{2}))^2)
![Equation d = s√(4 + 2√2)](https://latex.codecogs.com/svg.image?\Large&space;d=s\sqrt{4+2\sqrt{2}})
...
- **Diagonal \( d \):** ![Equation d = s√(4 + 2√2)](https://latex.codecogs.com/svg.image?\Large&space;d=s\sqrt{4+2\sqrt{2}})
- **Width \( w \):** ![Equation w = s(1 + √2)](https://latex.codecogs.com/svg.image?\Large&space;w=s(1+\sqrt{2}))
- **Segment \( x \):** ![Equation x = s / √2](https://latex.codecogs.com/svg.image?\Large&space;x=\frac{s}{\sqrt{2}})
