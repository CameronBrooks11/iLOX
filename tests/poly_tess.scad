...
m_oct = 6;
rot_oct = true;
centers_grid_oct = octagon_centers(radius=rad_oct, spacing=space_oct, n=n_oct, m=m_oct, rotate=rot_oct);
...
centers_levels_oct = octagon_centers(radius=rad_oct, spacing=space_oct, levels=lvls_oct, rotate=rot_oct);
...
centers_levels_hex = hexagon_centers(radius=rad_hex, spacing=space_hex, levels=lvls_hex);
...
centers_grid_hex = hexagon_centers(radius=rad_hex, spacing=space_hex, n=n_hex, m=m_hex);
